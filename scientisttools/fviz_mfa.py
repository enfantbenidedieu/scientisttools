...
def fviz_mfa_ind(self,
    ...
    if self.model_ not in ["mfa","mfaqual","mfamix"]:
        raise ValueError("Error : 'self' must be an object of class MFA, MFAQUAL, MFAMIX")
...
def fviz_mfaqual_var(self,
                 ...
                 ggtheme=pn.theme_minimal()) -> pn:
    """
    Visulize Multiple Factor Analysis for Qualitatives Variables (MFAQUAL) - Graph of qualitative variable categories
    ------------------------------------------------------------------------------------------------------------------
