...
def fviz_contrib(obj,
    ...
    **kwargs : Any
    ...
    See also
    --------
    fviz_cos2 : Visualize the quality of representation of row/columns elements
    ...
    .. figure:: ../_static/fviz_contrib_ind.png
    ...
    .. figure:: ../_static/fviz_contrib_levels.png
                                
            Contributions of variables categories
    
    >>> # contributions of categorical variables
    >>> p = fviz_contrib(clf,choice="quali_var",axis=0)
    >>> print(p.show())
    
    .. figure:: ../_static/fviz_contrib_quali_var.png
