...
class CatVARKMeansPC(BaseEstimator,TransformerMixin):
    ...
    **kwargs : key words parameters
    ...
    See Also
    --------
    CatVARHCPC : Categorical Variables Hierachical Clustering on Principal Components
    ...
    def fit(self,obj,y=None,sample_weight=None):
        ...
        call_ = {"obj":obj,"X":D,"D":D,"data_clust":concat((D,cluster),axis=1),"w":w,"ncl":ncl,"km":km}
