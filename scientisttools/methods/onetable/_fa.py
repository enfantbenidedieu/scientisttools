...
class FA(BaseEstimator,TransformerMixin):
    ...
    evd_ : evd
        ...
        d : 1d array-like of shape of shape
            The eigen values
        V : 2d array-like of shape
            The eigen vectors
        rank : int
    ...
    quali_var_sup_ : quali_var_sup, optional
        ...
        coord : DataFrame of shape (n_levels, ncp)
            The coordinates of the supplementary qualitative variables. The squared correlation ratio of the supplementary qualitative variables, 
    ...
    References
    ----------
    [1] Berger J-L. Analyse factorielle exploratoire et analyse en composantes principales : guide pratique. 2021. `hal-03436771v2 <https://hal.science/hal-03436771v2>`_

    [2] D. Suhr Diana. `Prinicpal Component Analysis vs. Exploratory Factor Analysis <https://support.sas.com/resources/papers/proceedings/proceedings/sugi30/203-30.pdf>`_. 2005. University of Northern Colorado.

    [3] Lawley, D.N., Maxwell, A.E. Factor Analysis as a Statistical Method. 1963. Butterworths Mathematical Texts. England

    [4] Marley W. Watkins. Exploratory Factor Analysis : A guide to best practice. 2018. Journal of Black Psychology, Vol. 44(3) 219-246
    ...
    def fit(self,X,y=None):
        ...
        eigenvals, eigenvects = eigenvals[:rank], eigenvects[:,:rank]
        ...
        call_ = {"Xtot":Xtot,"X":X,"Z":Z,"M":M,"row_w":row_w,"col_w":col_w,"center":center,"scale":scale,"ncp":ncp,
        ...
        self.evd_ = namedtuple("evd",["V","d","rank","ncp"])(eigenvects,eigenvals,rank,ncp)
    ...
    def fit_transform(self,X,y=None):
        ...
        ----------
        X : DataFrame of shape (n_rows, n_columns)
            Training data, where ``n_rows`` is the number of samples 
            and ``n_columns`` is the number of columns.
    ...
    def transform(self,X):
        ...
        ----------
        X : Dataframe of shape (n_rows, n_columns)
            New data, where ``n_rows`` is the number of samples 
            and ``n_columns`` is the number of columns.
