---
title: "Iterative Principal Factor Analysis (IPFA)"
...
res_fa = FactorAnalysis(n_components=2,rotate=None,max_iter=50)
#training
res_fa.fit(beer)
```
...
```{python}
#varimax rotation
res_fa = FactorAnalysis(n_components=2,rotate="varimax",max_iter=50)
res_fa.fit(beer)
```
...
```{python}
#oblimax rotation
res_fa = FactorAnalysis(n_components=2,rotate="oblimax",max_iter=50)
res_fa.fit(beer)
```
...
```{python}
#quartimax rotation
res_fa = FactorAnalysis(n_components=2,rotate="quartimax",max_iter=50)
res_fa.fit(beer)
```
...
```{python}
#equamax rotation
res_fa = FactorAnalysis(n_components=2,rotate="equamax",max_iter=50)
res_fa.fit(beer)
```
...
```{python}
#geomin_ort rotation
res_fa = FactorAnalysis(n_components=2,rotate="geomin_ort",max_iter=50)
res_fa.fit(beer)
```
...
```{python}
#promax rotation
res_fa = FactorAnalysis(n_components=2,rotate="promax",max_iter=50)
res_fa.fit(beer)
```
...
```{python}
#oblimin rotation
res_fa = FactorAnalysis(n_components=2,rotate="oblimin",max_iter=50)
res_fa.fit(beer)
```
...
```{python}
#quartimin rotation
res_fa = FactorAnalysis(n_components=2,rotate="quartimin",max_iter=50)
res_fa.fit(beer)
```
...
```{python}
#quartimin rotation
res_fa = FactorAnalysis(n_components=2,rotate="geomin_obl",max_iter=50)
res_fa.fit(beer)
```
